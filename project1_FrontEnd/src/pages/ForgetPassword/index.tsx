...
const ForgetPassword = () => {
  ...
  const renderStep1 = () => (
    <form onSubmit={formikStep1.handleSubmit} className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 max-w-md w-full mx-auto transition-colors duration-300">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Nhập email hoặc số điện thoại đã đăng ký để nhận mã xác thực khôi phục mật khẩu.</p>

      <div className="mb-6">
        <label className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">Email hoặc số điện thoại</label>
      ...
      <button
        type="submit"
        className="w-full bg-[#005C61] hover:bg-teal-800 dark:bg-teal-600 dark:hover:bg-teal-500 cursor-pointer text-white font-medium py-3 rounded-lg transition-colors flex justify-center items-center gap-2 mb-6 text-base"
      >
        Gửi mã xác thực
  ...
  const renderStep2 = () => (
    <div className="max-w-md w-full mx-auto">
      <div className="bg-[#005C61] dark:bg-teal-700 text-white p-3 rounded-lg mb-4 flex items-center gap-2 text-sm">
      ...
      <form onSubmit={formikStep2.handleSubmit} className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Mã xác thực đã được gửi đến email/số điện thoại của bạn. Vui lòng nhập mã 6 chữ số bên dưới.</p>
        ...
        <button type="submit" className="w-full bg-[#B2451C] hover:bg-orange-800 dark:bg-orange-600 dark:hover:bg-orange-500 text-white font-medium py-3 rounded-lg transition-colors mb-6 text-base">
          Xác thực mã
        </button>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
            Không nhận được mã?{" "}
            <button type="button" className="text-gray-400 dark:text-gray-500 font-medium hover:text-gray-600 dark:hover:text-gray-300">
              Gửi lại mã (sau 58s)
            </button>
          </p>
          <button type="button" onClick={() => setStep(1)} className="text-sm text-gray-500 dark:text-gray-400 font-medium hover:text-gray-800 dark:hover:text-white inline-flex items-center gap-1">
  ...
  const renderStep3 = () => (
    <form onSubmit={formikStep3.handleSubmit} className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 max-w-md w-full mx-auto transition-colors duration-300">
      ...
      <button type="submit" className="w-full bg-[#005C61] hover:bg-teal-800 dark:bg-teal-600 dark:hover:bg-teal-500 text-white font-medium py-3 rounded-lg transition-colors flex justify-center items-center gap-2 mb-6 text-base">
        Cập nhật mật khẩu
        <Icon icon="solar:arrow-right-outline" className="text-xl" />
      </button>
