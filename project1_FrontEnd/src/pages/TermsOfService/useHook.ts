...
export const useTermsOfService = () => {
  ...
  const contentVi = {
    ...
    guidelines: [
      ...
      {
        text: t(
          "Quy tắc Bảng tin tuyển dụng (Job Board), hướng dẫn cách Khách hàng đăng tin tuyển dụng và Người giúp việc nộp hồ sơ nhận việc trực tiếp;"
        ),
        icon: "material-symbols:work-outline"
      },
      {
        text: t(
          "Các biện pháp thực thi chính sách, bảo vệ an toàn cho các bên, bao gồm cả quyền hạn chế/khóa tài khoản tạm thời hoặc vĩnh viễn khi phát hiện gian lận."
        ),
    ...
    simplifiedIntro: t(
      "Mỗi nền tảng đều có các quy định riêng. Sau đây là điều khoản hoạt động của chúng tôi, nhằm duy trì môi trường tìm việc làm và đặt người giúp việc an toàn, uy tín."
    ),
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          t(
            "Mọi tương tác như cập nhật trạng thái đặt lịch, hủy lịch hoặc lưu lịch sử thanh toán đều được thực hiện minh bạch qua hệ thống thông báo thời gian thực."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Bạn chỉ có thể sử dụng Gia Đình Việt nếu từ 18 tuổi trở lên để có đủ tư cách pháp lý thực hiện các giao dịch đặt lịch và thỏa thuận lao động."
        ),
        paragraphs: [
          t(
            "Khi tạo tài khoản trên Gia Đình Việt, bạn cam kết cung cấp thông tin chính xác, đầy đủ bao gồm họ tên, số điện thoại liên hệ, email và địa chỉ khu vực hoạt động."
          ),
          t(
            "Bất kỳ ai dưới 18 tuổi đều không được phép tự tạo tài khoản hoặc đăng tải thông tin tìm việc trên bảng tin tuyển dụng mà không có sự giám hộ của cha mẹ hoặc người đại diện pháp luật."
          ),
          t(
            "Nghiêm cấm hành vi sử dụng các công cụ tự động hoặc tập lệnh để dò tìm, thu thập dữ liệu trái phép (crawler) bài đăng tuyển dụng hoặc thông tin hồ sơ của Người giúp việc."
          ),
          t(
            "Mọi hành vi giả mạo thông tin lý lịch cá nhân, bằng cấp chuyên môn hay hồ sơ khách hàng sẽ dẫn đến việc đình chỉ tài khoản ngay lập tức."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Các tin đăng tuyển việc, hồ sơ năng lực, đánh giá và nhận xét đều do chính bạn đăng tải và bạn tự chịu trách nhiệm pháp lý về độ xác thực của các nội dung đó."
        ),
        paragraphs: [
          t(
          ...
          t(
            "Nội dung do bạn đăng tải không được chứa các thông tin thô tục, phân biệt đối xử, lừa đảo hoặc vi phạm quyền sở hữu trí tuệ của bên thứ ba."
          ),
          t(
      ...
      },
      {
        ...
        paragraphs: [
          t(
            "Toàn bộ tài sản trí tuệ bao gồm thiết kế, mã nguồn, tên thương hiệu Gia Đình Việt và các quy trình công nghệ vận hành thuộc quyền sở hữu độc quyền của chúng tôi."
          ),
          t(
          ...
          t(
            "Hành vi sao chép thiết kế, dịch ngược mã nguồn hệ thống để tạo các sản phẩm phái sinh mà không có sự đồng ý bằng văn bản của chúng tôi là vi phạm pháp luật."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Bảo mật tài khoản của bạn bằng cách giữ kín mật khẩu. Thông báo ngay cho Gia Đình Việt nếu phát hiện tài khoản bị xâm nhập."
        ),
        paragraphs: [
          t(
      ...
      },
      {
        ...
        simplified: t(
          "Hệ thống tích hợp các cổng thanh toán bên thứ ba (như VNPay Sandbox). Trách nhiệm an toàn giao dịch thuộc về các cổng thanh toán liên kết này."
        ),
        paragraphs: [
          t(
            "Gia Đình Việt có tích hợp các đường dẫn hoặc cổng thanh toán của bên thứ ba, điển hình là cổng thanh toán điện tử VNPay Sandbox nhằm tạo thuận lợi cho việc giao dịch trực tuyến."
          ),
          t(
      ...
      },
      {
        ...
        simplified: t(
          "Chúng tôi có quyền tạm ngừng cung cấp dịch vụ hoặc khóa tài khoản vĩnh viễn nếu bạn gửi báo cáo/đánh giá lừa đảo hoặc vi phạm điều khoản nghiêm trọng."
        ),
        paragraphs: [
          t(
            "Chúng tôi bảo lưu quyền từ chối cung cấp dịch vụ, tạm ngừng hoặc xóa tài khoản của người dùng vi phạm nghiêm trọng hoặc lặp lại các cam kết tại điều khoản này."
          ),
          t(
            "Bạn cũng có quyền yêu cầu xóa tài khoản cá nhân bất kỳ lúc nào thông qua phần Cài đặt Hồ sơ hoặc liên hệ Hỗ trợ khách hàng qua email của chúng tôi."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Nếu hành vi gian lận hoặc vi phạm của bạn gây tổn hại vật chất hoặc pháp lý cho Gia Đình Việt hay các đối tác liên kết, bạn sẽ chịu trách nhiệm bồi thường chi phí phát sinh."
        ),
        paragraphs: [
          t(
      ...
      },
      {
        ...
        simplified: t(
          "Chúng tôi cung cấp hệ thống kết nối trên nền tảng 'như hiện trạng' (as-is) và không cam kết tuyệt đối dịch vụ hoàn hảo 100% không phát sinh lỗi."
        ),
        paragraphs: [
          t(
          ...
          t(
            "Gia Đình Việt không đảm bảo rằng hệ thống sẽ luôn hiển thị liên tục, không bị ngắt quãng hoặc tuyệt đối không bị nhiễm mã độc trong mọi tình huống."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Chúng tôi không chịu trách nhiệm pháp lý đối với bất kỳ xung đột ngoài mong muốn nào xảy ra trực tiếp giữa Khách hàng và Người giúp việc trong quá trình làm việc tại nhà."
        ),
        paragraphs: [
          t(
          ...
          t(
            "Mối quan hệ làm việc thực tế cấu thành giữa Khách hàng và Người giúp việc được thiết lập dựa trên thỏa thuận dân sự tự nguyện của hai bên."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Mọi tranh chấp giữa các bên trước hết sẽ được ưu tiên giải quyết qua thương lượng hòa giải tại Gia Đình Việt trước khi khởi tố ra tòa án."
        ),
        paragraphs: [
          t(
            "Khi có khiếu nại về chất lượng công việc hoặc phát sinh giao dịch đặt lịch lỗi, Khách hàng hoặc Người giúp việc cần thông báo ngay trong vòng 48 giờ để Ban quản trị tổ chức giải quyết."
          ),
          t(
            "Nếu tranh chấp không thể giải quyết bằng thương lượng sau 60 ngày kể từ khi gửi thông báo, vụ việc sẽ được đệ trình lên cơ quan Trọng tài thương mại hành chính tại Việt Nam để phân xử."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Điều khoản này hoạt động và chịu sự điều chỉnh hoàn toàn bởi hệ thống luật pháp nước Cộng hòa Xã hội Chủ nghĩa Việt Nam."
        ),
        paragraphs: [
          t(
            "Mọi tranh chấp không thuộc thẩm quyền giải quyết nội bộ sẽ được đưa ra phân xử tại Tòa án nhân dân có thẩm quyền tại Thành phố Hồ Chí Minh, Việt Nam."
          )
        ]
      },
      {
        ...
        simplified: t(
          "Chúng tôi có thể cập nhật các nội dung điều khoản bất kỳ lúc nào để tuân thủ luật pháp và sẽ thông báo công khai tới người dùng."
        ),
        paragraphs: [
          t(
            "Việc thay đổi chính sách bảo mật, thanh toán hoặc tuyển dụng sẽ luôn được cập nhật ở trang web này. Tiếp tục sử dụng Dịch vụ đồng nghĩa bạn chấp thuận các nội dung bổ sung mới nhất."
          ),
          t(
            "Mọi câu hỏi, phản hồi hoặc yêu cầu hỗ trợ tài khoản xin vui lòng liên hệ với ban quản trị của chúng tôi qua hòm thư điện tử chính thức: hungvuong04.dev@gmail.com."
          )
        ]
      }
    ]
  ...
  const contentEn = {
    ...
    intro: "These Terms of Service (\"Terms\") govern your access to and use of any website, application, services, technology, API, or any other product or features provided by Gia Dinh Viet (\"Services\"), except where we explicitly state that separate terms apply. For these Terms, \"we\" refers to the management board of Gia Dinh Viet. Please read these Terms carefully and contact us if you have any questions.",
    ...
    sections: [
      {
        ...
        number: "1",
        title: "Our Services",
        simplified: "Gia Dinh Viet connects Customers looking for domestic help with potential Helpers, as well as providing job postings. We use your parameters to match you with appropriate service partners.",
        paragraphs: [
      ...
      },
      {
        ...
        simplified: "Gia Dinh Viet owns the user interface design, stylesheets, logotypes, brand name, codebase, and database structures. You are granted usage rights, but you may not duplicate them.",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Any dispute outside our internal resolution capabilities will be submitted for settlement to the competent people's court in Ho Chi Minh City, Vietnam."
        ]
      },
      {
        id: "section-13",
