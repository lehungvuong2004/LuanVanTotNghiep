    ...
    <footer className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-14">
        <div className="flex flex-col gap-4 pr-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{t("Nền tảng kết nối dịch vụ gia đình hàng đầu Việt Nam. Chuyên nghiệp - Tận tâm - Minh bạch.")}</p>
