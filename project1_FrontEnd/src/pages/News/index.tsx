        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {news.map((item, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`overflow-hidden bg-slate-100 dark:bg-slate-900 shrink-0 ${
                    isFeatured
                      ? "aspect-[16/9] lg:aspect-auto lg:h-[300px] xl:h-[340px]"
                      : "aspect-[16/9]"
                  }`}
                >
                  {item.thumbnail ? (
                ...
                <div className={`p-5 flex flex-col grow ${isFeatured ? "lg:p-6" : ""}`}>
                  ...
                  <h2
                    className={`font-bold text-slate-800 dark:text-slate-100 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors leading-snug mb-2 ${
                      isFeatured ? "text-lg lg:text-2xl" : "text-base"
                    }`}
                  >
                    {item.title}
                  </h2>
                  {item.summary && (
                    <p
                      className={`text-sm text-slate-500 dark:text-slate-400 leading-relaxed mb-4 grow ${
                        isFeatured ? "line-clamp-3 lg:line-clamp-5" : "line-clamp-2"
                      }`}
                    >
                      {item.summary}
                    </p>
