...
export const Toggle = ({ checked, onChange, disabled = false, activeLabel, inactiveLabel }) => {
  ...
  return (
    <div className="flex items-center gap-2 select-none">
      ...
      <span className="text-xs font-semibold text-slate-500 dark:text-slate-400 min-w-16">{checked ? displayActive : displayInactive}</span>
    </div>
  );
};
