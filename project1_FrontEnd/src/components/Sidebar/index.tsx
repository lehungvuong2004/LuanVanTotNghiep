...
const NAV_ITEMS_BY_ROLE = {
  [ROLES.ADMIN]: [
    { name: 'Quản lý Người dùng', path: '/admin/users', icon: 'material-symbols:group-outline-rounded' },
    { name: 'Quản lý Phân quyền', path: '/admin/roles', icon: 'material-symbols:shield-person-outline-rounded' },
    { name: 'Quản lý Tin tức', path: '/admin/news', icon: 'material-symbols:newspaper-outline-rounded' },
    { name: 'Quản lý Banner', path: '/admin/banners', icon: 'material-symbols:ad-units-outline-rounded' },
    { name: 'Quản lý Liên hệ', path: '/admin/contacts', icon: 'material-symbols:contact-phone-outline-rounded' },
    { name: 'Quản lý Danh mục Phân loại', path: '/admin/categories', icon: 'boxicons:categories' },
    { name: 'Quản lý Dịch vụ', path: '/admin/services', icon: 'grommet-icons:services' },
    { name: 'Kiểm duyệt Hồ sơ', path: '/admin/helpers', icon: 'material-symbols:engineering-outline-rounded' },
    { name: 'Quản lý Báo cáo', path: '/admin/reports', icon: 'material-symbols:report-outline' },
    { name: 'Lịch sử Hoạt động', path: '/admin/activity-logs', icon: 'material-symbols:history-rounded' },
    { name: 'Quản lý Thanh toán', path: '/admin/payments', icon: 'material-symbols:payments-outline-rounded' },
    { name: 'Quản lý Hoàn tiền', path: '/admin/refunds', icon: 'material-symbols:undo-rounded' },
    { name: 'Thống kê & Báo cáo', path: '/admin/dashboard', icon: 'material-symbols:bar-chart-outline-rounded' },
    { name: 'Quản lý Tin nhắn', path: '/admin/messages', icon: 'material-symbols:chat-outline' },
    { name: 'Quản lý Thông báo', path: '/admin/notifications', icon: 'material-symbols:notifications-outline-rounded' },
  ],
  [ROLES.OPERATOR]: [
      ...
      <div>
        ...
        <div className={`px-4 mb-8 mt-4 ${isCollapsed ? "flex flex-col items-center" : ""}`}>
          <div className="flex items-center gap-3">
            ...
            {!isCollapsed && (
              <div>
                <h1 className={`font-bold text-base ${theme.brandText} leading-tight truncate max-w-31.25`}>
                  Gia Đình Việt
                </h1>
