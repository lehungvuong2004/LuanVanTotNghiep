...
export const navItems = [
  ...
  { name: 'Roles', path: '/admin/roles', icon: 'material-symbols:shield-person-outline-rounded' },
  ...
  { name: 'Job Posts', path: '/admin/job-posts', icon: 'material-symbols:post-add-rounded' },
