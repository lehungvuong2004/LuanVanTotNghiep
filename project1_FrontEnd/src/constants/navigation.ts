...
export const NAV_ITEMS = {
  ...
  [ROLES.ADMIN]: [
    { name: "Thống kê & Báo cáo", path: "/admin/dashboard", icon: "icon-park-outline:analysis", permission: "dashboard.view" },  // xong check lại giao diện
    { name: "Quản lý Người dùng", path: "/admin/users", icon: "material-symbols:group-outline-rounded", permission: "users.view" }, // has check permission in UI 
    { name: "Kiểm duyệt Hồ sơ", path: "/admin/helpers", icon: "material-symbols:engineering-outline-rounded", permission: "helper_profile.verify" }, // của người giúp việc đúng không  ? 
    { name: "Quản lý Dịch vụ", path: "/admin/services", icon: "grommet-icons:services", permission: "services.view" },  // 3
    { name: "Quản lý Danh mục Phân loại", path: "/admin/categories", icon: "boxicons:categories", permission: "categories.view" },  // has check permission in UI
    { name: "Quản lý Thanh toán", path: "/admin/payments", icon: "material-symbols:payments-outline-rounded", permission: "payments.view" },  // 3 
    { name: "Quản lý Hoàn tiền", path: "/admin/refunds", icon: "material-symbols:undo-rounded", permission: "refunds.view" }, // 3
    ...
    { name: "Quản lý Thông báo", path: "/admin/notifications", icon: "material-symbols:notifications-outline-rounded", permission: "notifications.view" }, // 3
    { name: "Quản lý Liên hệ", path: "/admin/contacts", icon: "material-symbols:contact-phone-outline-rounded", permission: "contacts.view" },  // 3
    { name: "Quản lý Tin tức", path: "/admin/news", icon: "material-symbols:news", permission: "news.view" }, // has check permission in UI
    { name: "Quản lý Banner", path: "/admin/banners", icon: "material-symbols:ad-units-outline-rounded", permission: "banners.view" },  // has check permission in UI
    { name: "Ma trận quyền hạn", path: "/admin/permissions", icon: "dinkie-icons:display-dot-matrix", permission: "permissions.view" }, // has check permission in UI
    { name: "Vai trò hệ thống", path: "/admin/roles", icon: "material-symbols:shield-person-outline-rounded", permission: "roles.view" }, // has check permission in UI
    { name: "Lịch sử Hoạt động", path: "/admin/activity-logs", icon: "material-symbols:history-rounded", permission: "activity_logs.view" }, // 0
  ],
