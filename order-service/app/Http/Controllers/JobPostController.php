...
class JobPostController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    // Chống spam: Kiểm tra xem trong 5 phút gần nhất đã có bài cùng tiêu đề của customer này chưa
    $isDuplicate = JobPost::where('customer_id', $request->authUser['id'])
    ...
    if ($isDuplicate) {
      return $this->errorResponse(
        'Bạn đã đăng một công việc tương tự cách đây ít phút. Vui lòng đợi một lát hoặc thay đổi tiêu đề.',
