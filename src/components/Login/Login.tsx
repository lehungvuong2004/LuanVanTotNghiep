      ...
      <div className="max-w-lg w-full mx-auto">
        ...
        <form className="space-y-5" onSubmit={formik.handleSubmit}>
          <div className="space-y-1.5">
            ...
            {formik.touched.emailOrPhone && formik.errors.emailOrPhone ? <p className="text-xs text-red-500">{formik.errors.emailOrPhone}</p> : null}
          </div>
        ...
        <p className="text-xs leading-tight text-center text-gray-400 max-w-[280px] mx-auto">Hệ thống sẽ tự động chuyển đến trang phù hợp theo vai trò tài khoản của bạn</p>
      </div>
    </div>
  );
